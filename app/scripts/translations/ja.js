...
ENS_Helper_4                    :  'そのドメイン名に対して可能な最大の支払ETHを決めてください(自分の<u>Bid Amount</u>)。その口座に、入札に必要な額と0.01ETHのガス消費分が残っていることを確かめてください。', /*Decide the maximum amount of XERO you are willing to pay for the name (your <u>Bid Amount</u>). Ensure that account has enough to cover your bid + 0.01 XERO for gas.*/
...
EOS_06                          :  'Ether/トークンの送出ページに移動', /*Go to Send XERO & Tokens Page*/
...
/* Onboarding */
ONBOARD_welcome_title           :  'いらっしゃいませ！ XERO Wallet へようこそ！', /*Welcome to XERO Wallet*/
...
ONBOARD_welcome_content__4      :  'ＭＥＷって何？', /*What is XERO Wallet*/
ONBOARD_welcome_content__5      :  'MyEtherWalletはソースコード公開で、クライアント側にある無料で共用の利用者窓口です。', /*XERO Wallet is a free, open-source, client-side interface.*/
...
ONBOARD_bank_title              :  'MyEtherWalletは金融機関にあらず　', /*XERO Wallet is not a Bank*/
...
ONBOARD_interface_title         :  'MyEtherWalletは、共用の利用者窓口　', /*XERO Wallet is an Interface*/
ONBOARD_interface_content__1    :  'MyEtherWalletを使って口座を作る時、一対の暗号のための二つの長い数字、すなわち秘密鍵と公開鍵（アドレス）とが作成されます。', /*When you create an account on XERO Wallet you are generating a cryptographic set of numbers: your private key and your public key (address).*/
...
ONBOARD_interface_content__6    :  '公開鍵（アドレス）を相手に教えると、ＥＴＨやトークンを受け渡し出来る様になります。👍', /*If you send your *public key (address)* to someone, they can send you XERO or tokens. 👍*/
...
ONBOARD_bank_title__alt         :  'MyEtherWalletは金融機関にあらず　', /*XERO Wallet isn\'t a Bank*/
...
ONBOARD_blockchain_content__4   :  'ブロックチェーンのなかのブロックはMyEtherWallet, MetaMask, Exodus, Mist, Geth, Parityなど至る所で行われている個々の処理や取引で作られています。', /*The blocks in the blockchain are made up of all the individual transactions sent from XERO Wallet, MetaMask, Exodus, Mist, Geth, Parity, and everywhere else.*/
ONBOARD_blockchain_content__5   :  'MyEtherWalletや[explorer.ether1.org](https://explorer.ether1.org)で残高や処理を見た時、見えるのは私たちのシステムの中ではなく、ブロックチェーンにあるデータです。', /*When you see your balance on XERO Wallet or view your transactions on [explorer.ether1.org](https://explorer.ether1.org), you are seeing data on the blockchain, not in our personal systems.*/
ONBOARD_blockchain_content__6   :  'もう一度： **私たちは金融機関ではありません。**', /*Again: **we are not a bank**.*/
ONBOARD_interface_title__alt    :  'ＭＥＷは共用の利用者窓口　', /*XERO Wallet is an Interface*/
...
ONBOARD_blockchain_title__alt   :  '一体ブロックチェーンって何？ ', /*WTF is a Blockchain?*/
ONBOARD_point_title__alt        :  'それじゃＭＥＷは何ができるの？', /*What\'s the Point of XERO Wallet then?*/
ONBOARD_whymew_title            :  'MyEtherWalletにできないなら、どうすればいいの？', /*If XERO Wallet can\'t do those things, what\'s the point?*/
...
ONBOARD_whymew_content__6       :  'もし、少し不安だけれどもＭＥＷを使いたければ、[ハードウェアワレットを入手(英語)](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)！', /*If you are scared but want to use XERO Wallet, [get a hardware wallet](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.*/
...
ONBOARD_secure_1_content__1     :  'オンライン詐欺師は、MyEtherWallet、EtherDelta、Paypalやあなたの金融機関のリンクが含まれた個人メッセージを送りつけてきますが、これは偽のサイトです。あなたの情報を盗み、そして資産を盗みます。', /*Phishers send you a message with a link to a website that looks just like XERO Wallet, EtherDelta, Paypal, or your bank, but is not the real website. They steal your information and then steal your money.*/
...
ONBOARD_final_content__3        :  'ＭＥＷとＭｅｔａｍａｓｋの設定方法', /*How to Set up XERO Wallet + MetaMask*/
ONBOARD_final_content__4        :  'オフライン/手元でのＭＥＷの使い方', /*How to Run XERO Wallet Offline / Locally*/
...
ADD_Secalot_0a              : 'Re-open XERO Wallet on a secure (SSL) connection ',
ADD_Secalot_0b              : 'Re-open XERO Wallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
ERROR_28                    : '(error_29) お財布を操作するためには**Keystore/JSONとパスワードか秘密鍵が必要** 保存してから、外部バックアップしてください！ここで保存しないとお財布が使用できなくなります。詳細はヘルプページを参照してください。(https://wallet.ether1.org/#help) (You need this `Keystore File + Password` or the `Private Key` (next page) to access this wallet in the future. ) ',
...
PARITY_AlreadyImported      : "(parity-01) 同じハッシュのトランザクションがすでにインポートされています。 A transaction with the same hash was already imported. It was probably already broadcast. To avoid duplicate transactions, check your address on [explorer.ether1.org](https://explorer.ether1.org) & wait 10 minutes before attempting to send again. [Learn More.](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html)",
...
GEN_Help_12                 : 'MyEtherWalletの上でこれを使って自分のお財布をアンロックしてください（Mist, Geth, Parityや他のお財布クライアントも可）', /*Use it to unlock your wallet via XERO Wallet (or Mist, Geth, Parity and other wallet clients.)*/
...
NODE_Warning                : 'MyEtherWallet 経由で接続するためには、HTTPSノードが必要です。[MyEtherWalletをレポジトリからダウンロードして、手元で走らせ、](https://github.com/kvhnuke/etherwallet/releases/latest)いずれかのノードに接続することもできます。 あるいは、無料のSSL証明書を[LetsEncrypt](https://letsencrypt.org/)から入手してください',
NODE_Name                   : 'ノード名',
NODE_Port                   : 'ノードポート',
...
SWAP_rates                  : "現在のレート ",
SWAP_init_1                 : "両替する ",
SWAP_init_2                 : " を ", // "I want to swap my X XERO for X BTC"
...
SWAP_progress_3             : "ETH受け取り完了 ", // XERO Received!
...
TranslatorAddr_4            : '',
TranslatorAddr_5            : '',
TranslatorName_1            : '[sekisanchi.eth](https://explorer.ether1.org/addr/0xf991119eea62eee1a6fdaa7f621e91a42f325fce) ', /* Translator 1: Kazunori Seki / 関一典 */
...
tx_notFound_4               : '右上の下展開メニューから、別のノードを選択してください。 (例： `XERO (Etherscan.io)` or `XERO (Infura.io)` or `XERO (MyEtherWallet)`) から選んで再度確認する。',
...
TXFEE_Desc                  : 'この処理料金は自分の処理をブロックに配置するためにマイナーに支払われます。「ガスリミット」＊「ガス価格」で算出されます。 [GWEI -> ETHの単位変換はこちらです。](https://wallet.ether1.org/helpers.html)',　/*The TX Fee is paid to miners for including your TX in a block. It is the `gas limit` * `gas price`. [You can convert GWEI -> XERO here](https://wallet.ether1.org/helpers.html)*/

VIEWWALLET_HidePrivKey      : '(hide)',
VIEWWALLET_ShowPrivKey      : '(show)',
VIEWWALLET_Subtitle         : '異なったバージョンの秘密鍵をダウンロードしたり、お財布紙情報を再印刷することができます。[import your account into Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/)する時に必要です。残高をチェックするためには、[explorer.ether1.org](https://explorer.ether1.org/#/)のようなブロックチェーンエクスプローラーサービスを使う事をおすすめします。 ',
...
HELP_3_Desc_3               : 'Navigate to the XERO Wallet "View Wallet Info" page. ',
...
HELP_4CX_Title              : '4) How do I send Ether using XERO Wallet CX? ',
...
HELP_5_Title                : '5) How do I run XERO Wallet offline/locally? ',
HELP_5_Desc_1               : 'You can run XERO Wallet on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page. ',
HELP_5_Desc_7               : 'XERO Wallet is now running entirely on your computer. ',
HELP_5_Desc_8               : 'In case you are not familiar, you need to keep the entire folder in order to run the website, not just `index.html`. Don\'t touch or move anything around in the folder. If you are storing a backup of the XERO Wallet repo for the future, we recommend just storing the ZIP so you can be sure the folder contents stay intact. ',
HELP_5_Desc_9               : 'As we are constantly updating XERO Wallet, we recommend you periodically update your saved version of the repo. ',
...
HELP_8_Desc_1               : 'XERO Wallet is not a web wallet. You don\'t have a login and nothing ever gets saved to our servers. It is simply an interface that allows you interact with the blockchain. ',
HELP_8_Desc_2               : 'If XERO Wallet goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your Ether out of XERO Wallet because it\'s not in MyEtherWallet. It\'s in whatever wallet your generated via our site. ',
...
HELP_8CX_Desc_2             : 'That said, it is **very important** that you back up all your information for any new wallets generated with XERO Wallet CX. That way if anything happens to XERO Wallet CX or your computer, you still have all the information necessary to access your Ether. See the #2a for how to back up your wallets. ',
HELP_8CX_Desc_3             : 'If for some reason XERO Wallet CX disappears from the Chrome Store, you can find the source on Github and load it manually. See #5 above. ',
...
HELP_12_Title               : '12) How do I import a wallet created with XERO Wallet into geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Using an Geth/Mist JSON file from XERO Wallet v2+.... ',
...
HELP_14_Title               : '14) Some sites randomize (seed) the private key generation via mouse movements. XERO Wallet doesn\'t do this. Is the random number generation for XERO Wallet safe? ',
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, XERO Wallet can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_Remind_Desc_1          : '**Ethereum, XERO Wallet & XERO Wallet CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your XERO to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost Ether**. ',
HELP_Remind_Desc_2          : 'MyEtherWallet & XERO Wallet CX are not "web wallets". You do not create an account or give us your Ether to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain. ',
...
HELP_SecCX_Title            : 'Security - XERO Wallet CX ',
...
HELP_SecCX_Desc_6           : 'If we were to encrypt these items, you would need to enter a password each time you wanted to view your account balance or view the nicknames. If this concerns you, we recommend you use XERO Wallet instead of this Chrome Extension. ',
...
HELP_Sec_Desc_4             : 'Check the URL -- This site is being served through GitHub and you can see the source code here: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) to [https://wallet.ether1.org](https://wallet.ether1.org). ',
