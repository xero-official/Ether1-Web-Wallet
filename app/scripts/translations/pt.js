...
TRANS_data                  : 'Dados ',
TRANS_gas                   : 'Gás Limit ',
TRANS_sendInfo              : 'Uma transação padrão usando 21000 gás irá custar 0.000441 ETH. Nós usamos um preço ligeiramente acima do mínima de gás de 0,000000021 XERO para garantir que ele seja minado rapidamente. Nós não recebemos nenhuma taxa de transação. ',
...
TRANSModal_Content_1        : '**XERO (Transação Padrão): ** Isso gera uma transação padrão diretamente de um endereço para outro. Tem um gás padrão de 21000. É provável que qualquer XERO enviados através deste método serão repetidos para a cadeia ETC.. ',
...
MYWAL_Content_3             : 'Se pretender utilizar esta carteira com o XERO Wallet CX no futuro, terá de voltar a adicioná-la manualmente utilizando a chave privada/JSON e a palavra-passe. ',
...
ADD_Ledger_0a               : 'Re-abra XERO Wallet em uma conexão (SSL) segura ',
ADD_Ledger_0b               : 'Re-abra XERO Wallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Re-abra XERO Wallet em uma conexão (SSL) segura ',
ADD_DigitalBitbox_0b        : 'Re-abra XERO Wallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
...
ERROR_28                    : '**Você precisa do seu arquivo de armazenamento de chaves & senha** (ou Chave Privada) para acessar essa carteira no futuro. Por favor, salve e armazene ela externamente! Não há como recuperar uma carteira se você não salvar isso. Leia a [página de ajuda](https://wallet.ether1.org/#help) para instruções. ',
...
TranslatorName_1            : '[ Pedro "ShooterXD" Vieira ](https://wallet.ether1.org/?gaslimit=21000&to=0x24eB7d82166361A8B69adE6FEA187Cb00FD7c7E1&value=1.0#send-transaction) ',
TranslatorAddr_1            : '',
