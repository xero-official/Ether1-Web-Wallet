...
tx_notFound_4               : 'Bruk rullegardinmenyen øverst til høyre og velg en annen ETH-node. (f.eks. `XERO (Etherscan.io)` eller `XERO (Infura.io)` eller `XERO (MyEtherWallet)`), og sjekk igjen.',
...
tx_FoundOnChain_3           : '**Hvis du ikke ser noen feil, var transaksjonen vellykket.** Dine XERO eller Tokens er der du sendte dem. Hvis du ikke ser disse XERO eller Tokens der du sendte dem, og det har gått mer enn 24 timer, vennligst [kontakt vedkommende service](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Send dem en *lenke* til transaksjonen din og spør dem pent om å se på situasjonen din.',
...
GEN_Help_12                 : 'Bruk den sammen med passordet du oppga til å låse opp lommeboken din via XERO Wallet (eller Mist, Geth, Parity og andre lommebok-klienter.) ',
...
TXFEE_Desc                  : 'Transaksjonsavgiften betales til "utgraverne" for å inkludere transaksjonen din i en blokk. Det er `gas-grense` * `gas-pris`. [Du kan regne om GWEI -> XERO her](https://wallet.ether1.org/helpers.html)',
...
ADD_Ledger_0a               : 'Åpne XERO Wallet på nytt på en sikker (SSL) forbindelse. ',
ADD_Ledger_0b               : 'Åpne XERO Wallet på nytt med [Chrome](https://www.google.com/chrome/browser/desktop/) eller [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Åpne XERO Wallet på nytt på en sikker (SSL) forbindelse. ',
ADD_DigitalBitbox_0b        : 'Åpne XERO Wallet på nytt med [Chrome](https://www.google.com/chrome/browser/desktop/) eller [Opera](https://www.opera.com/) ',
...
TRANS_data                  : 'Data ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'En standard transaksjon som bruker 21000 gas vil koste 0,000441 ETH. Vi bruker en litt-over-minimum gas-pris på 0,000000021 XERO for å sikre at transaksjonen blir raskt behandlet. Vi tar ikke noe transaksjonsgebyr. ',
...
TRANSModal_Content_1        : '**XERO (Standardtransaksjon): ** Dette Oppretter en standardtransaksjon direkte fra en adresse ti en annen. Den har standard gas på 21000. Det er sannsynlig at XERO som sendes med denne metoden også vil bli sendt som ETC på ETC-kjeden (hvis kontoen inneholder både XERO og ETC). Dette er anbefalt metode hvis kontoen kun inneholder ETH. ',
...
SWAP_init_2                 : " med ", // "I want to swap my X XERO for X BTC"
...
SWAP_progress_3             : "Mottatt! ", // XERO Received!
...
SWAP_unlock                 : "Lås opp din lommebok for å sende XERO eller Tokens direkte fra denne siden. ",
...
ERROR_28                    : '**Du trenger din Keystore-fil & passord eller din private nøkkel** for å få tilgang til denne lommeboken i framtiden. Vennligst lagre og sikkerhetskopier den eksternt! Det finnes ingen måte å gjenopprette en lommebok på hvis du ikke lagrer den. Les [hjelpesiden](https://wallet.ether1.org/#help) for ytterligere instruksjoner (foreløpig kun på engelsk). ',
...
TranslatorName_1            : '[mrstormlars](https://wallet.ether1.org/?gaslimit=21000&to=mrstormlars.eth&value=1.0#send-transaction) ',
TranslatorAddr_1            : '',
...
HELP_Remind_Desc_1          : '**Ethereum, XERO Wallet & XERO Wallet CX, og noen av de underliggende Javascript-bibliotekene vi benytter er under aktiv utvikling.** Selv om vi har testet grundig, og titusenvis av lommebøker har blitt opprettet uten feil av folk over hele kloden, så er det alltid en liten mulighet for at noe uventet kan skje som kan medføre at dine XERO kan tapes. Vennligst ikke invester mer enn du er villig til å tape, and vær så snill å være forsiktig. Hvis noe skulle skje, er vi lei oss for det, men **vi er ikke ansvarlige for eventuelt tapte etere**. ',
HELP_Remind_Desc_2          : 'MyEtherWallet & XERO Wallet CX er ikke "web wallets" (internettlommebøker). Du oppretter ikke en konto eller gir oss dine ethere for oppbevaring hos oss. Alle data forblir på din PC / i din nettleser. Vi gjør det enkelt for deg å opprette, lagre og få tilgang til din informasjon og samhogle med blokkjeden. ',
...
HELP_3_Desc_3               : 'Naviger til XERO Wallet sin "Vis lommebok-info"-side. ',
...
HELP_4CX_Title              : '4) Hvordan sender jeg ether med XERO Wallet CX (Chrome-utvidelsen)? ',
...
HELP_5_Title                : '5) Hvordan kan jeg bruke XERO Wallet offline/lokalt? ',
HELP_5_Desc_1               : 'Du kan bruke XERO Wallet på datamaskinen din i stedet for fra GitHub-serverne. Du kan opprette en lommebok fullstendig frakoblet fra internett, og sende transaksjoner fra "Send offline"-siden. ',
HELP_5_Desc_7               : 'MyEtherWallet kjører nå utelukkende på din datamaskin. ',
...
HELP_5_Desc_9               : 'Siden vi oppdaterer XERO Wallet hele tiden, anbefaler vi at du oppdaterer din lagrede versjon av repoet jevnlig. ',
...
HELP_8_Desc_2               : 'Hvis XERO Wallet går ned, må du finne en annen måte (som f.eks. geth eller Ethereum Wallet / Mist) å gjøre det på. Men du vil ikke trenge å "hente" eteren din ut av XERO Wallet, fordi den ikke befinner seg i MyEtherWallet. Den befinner seg i den lommeboka/kontoen som du opprettet ved hjelp av nettsiden vår. ',
...
HELP_8_Desc_4               : 'I tillegg er sannsynligheten for at vi tar ned XERO Wallet svært liten. Det koster oss nesten ingenting å opprettholde den siden vi ikke lagrer noen informasjon. Hvis vi tar ned domenet, er det fortsatt, og vil alltid være, offentlig tilgjengelig på [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Du kan laste ned zip-fila der og kjøre den lokalt. ',

HELP_8CX_Title              : '8) Hva skjer hvis XERO Wallet CX (Chrome-utvidelsen) forsvinner? ',
...
HELP_8CX_Desc_2             : 'Når det er sagt, så er det **svært viktig** at du sikkerhetskopierer all din informasjon for alle lommebøkene som du har opprettet med XERO Wallet CX. På den måten vil du fortsatt ha all nødvendig informasjon for å få tilgang til eteren din selv om noe skulle hende med XERO Wallet CX eller datamaskinen din. Se spørsmål #2a ang. hvordan du sikkerhetskopierer lommebøkene dine. ',
HELP_8CX_Desc_3             : 'Hvis XERO Wallet CX av en eller annen grunn skulle forsvinne fra Chrome Store, så kan du finne kildekoden på Github og laste den inn manuelt. Se #5 ovenfor. ',
...
HELP_12_Title               : '12) Hvordan kan jeg importere en lommebok opprettet med XERO Wallet til geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Ved å bruke en Geth/Mist JSON-fil fra XERO Wallet v2+.... ',
...
HELP_16_Desc_1              : 'Du kan bruke en blokkjede-utforsker som [explorer.ether1.org](https://explorer.ether1.org/#/). Lim inn adressen i søkefeltet og den vil finne fram adressen og transaksjonshistorikken. For eksempel, her ser du hvordan vår [donasjonskonto](https://explorer.ether1.org/addr/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) ser ut på explorer.ether1.org ',

HELP_17_Title               : '17) Hvorfor vises ikke saldoen min når jeg låser opp lommeboken min? ',
HELP_17_Desc_1              : 'Dette er mest sannsynlig fordi du er bak en brannmur. API-en vi bruker for å innhente saldoen blokkeres ofte av brannmurer av ymse årsaker. Du vil fortsatt være i stand til å sende transaksjoner, du må bare bruke en annen metode for å se nevnte saldo, som explorer.ether1.org ',
...
HELP_SecCX_Title            : 'Datasikkerhet - XERO Wallet CX (Chrome-utvidelsen) ',
...
HELP_SecCX_Desc_6           : 'Hvis vi skulle kryptere disse, måtte du ha oppgitt et passord hver gang du ønsket å se saldo for kontoene dine eller vise kallenavnene. Hvis dette bekymrer deg, anbefaler vi deg å bruke XERO Wallet i stedet for denne Chrome-utvidelsen. ',
...
HELP_Sec_Desc_4             : 'Sjekk nettsideadressen (URL) -- Denne siden blir drevet gjennom GitHub og du kan se kildekoden her: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) til domenet: [https://wallet.ether1.org](https://wallet.ether1.org). ',
