...
tx_notFound_4               : 'Please use the dropdown in the top-right & select a different XEROM node (e.g. `XEROM (Etherscan.io)` or `XEROM (Infura.io)` or `XEROM (MyEtherWallet)`) and check again.',
...
GAS_LIMIT_Desc              : 'Gas limit is the amount of gas to send with your TX. `TX fee` = gas price * gas limit & is paid to miners for including your TX in a block. Increasing this number will not get your TX mined faster. Sending XEROM = `21000`. Sending Tokens = ~`200000`.',
...
TXFEE_Desc                  : 'The TX Fee is paid to miners for including your TX in a block. Is is the `gas limit` * `gas price`. [You can convert GWEI -> XEROM here](https://wallet.ether1.org/helpers.html)',
...
TRANSModal_Content_1        : '**XEROM (Standard Tranzakció): ** Egy alapértelmezett tranzakciót generál közvetlenül az egyik címről a másikra. A gas alapértéke 21000. Valószínűsíthető, hogy minden ETH, ami ezzel a módszerrel lesz elküldve, végbemegy az ETC láncon is. ',
...
SWAP_init_2                 : " for ", // "I want to swap my X XEROM for X BTC"
...
SWAP_progress_3             : "Received! ", // XEROM Received!
SWAP_progress_4             : "Sending your {{orderResult.output.currency}} ",
SWAP_progress_5             : "Order Complete ",
SWAP_order_CTA              : "Please send ", // Please send 1 ETH...
SWAP_unlock                 : "Unlock your wallet to send XEROM or Tokens directly from this page. ",
...
ERROR_28                    : '**Szükséged lesz a Keystore Fájlra és a jelszóra vagy a Privát Kulcsra**, ahhoz, hogy hozzáférj ehhez a tárcához a jövőben. Kérlek mentsd el és készíts külső biztonsági mentést is! Nincs lehetőség egy tárca visszaszerzésére, ha nem mented el. Olvasd el a [Segítség lapot](https://wallet.ether1.org/#help) további instrukciókért. ',
...
TranslatorName_1            : '[belpheg](https://wallet.ether1.org/?gaslimit=21000&to=0xBF8C35176eAD29257834D5A1592ed50Adb0b6e4f&value=1.0#send-transaction) · ',
TranslatorAddr_1            : '0xBF8C35176eAD29257834D5A1592ed50Adb0b6e4f ',
/* Translator 1             : email: zoltan.tapi@donamin.com */
TranslatorName_2            : '[bluqesh](https://wallet.ether1.org/?gaslimit=21000&to=0x4270A331d14CcdB6FB941f3f5De9Cf01607Bff9F&value=1.0#send-transaction) ',
...
HELP_3_Desc_3               : 'Menj a MyEtherWallet-on a "Tárca adatainak megtekintése" oldalra. ',
...
HELP_5_Desc_1               : 'Futtahatod a MyEtherWallet-ot a saját számítógépeden is, a GitHub szerverei nélkül. Így lehetőséged van teljesen offline generálni tárcákat, vagy Ethert küldeni az "Offline tranzakció" oldalról. ',
HELP_5_Desc_7               : 'A XERO Wallet most teljesen a te számítógépedről fut. ',
HELP_5_Desc_8               : 'Ha esetleg nem csináltál volna még ilyet: a teljes mappára szükséged van az oldal futtatásához, nem elég csak az "index.html" fájl. A mappában ne piszkálj / mozgass el semmit. Ha biztonsági másolatot szeretnél a XERO Wallet repo-ról későbbre, akkor az eredeti zip fájl tárolását javasoljuk, így biztos lehetsz benne hogy a tartalma érintetlen marad. ',
HELP_5_Desc_9               : 'Mivel folyamatosan frissítjük a MyEtherWallet-ot, ezért javasoljuk, hogy időközönként frissítsd a lementett repo-t is. ',
