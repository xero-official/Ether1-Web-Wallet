...
tx_notFound_4               : 'Veuillez utiliser le menu déroulant en haut à droite & sélectionner un nœud XERO différent (par ex. `XERO (Etherscan.io)` ou `XERO (Infura.io)` ou `XERO (MyEtherWallet)`) et revérifiez.',
...
tx_FoundOnChain_3           : '**Si vous ne voyez pas d\'erreur, votre transaction a été envoyée avec succès.** Vos XERO ou Tokens sont à l\'endroit où vous les avez envoyés. Si vous ne voyez pas ces XERO ou Tokens dans votre autre portefeuille ou compte de place d\'échange, et si cela fait plus de 24 heures, veuillez [contacter ce service](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Envoyez-leur le *lien* vers votre transaction et demandez, poliment, d\'examiner votre situation.',
...
GEN_Help_12                 : 'Utilisez-le pour déverouiller votre portefeuille avec XERO Wallet (ou Mist, Geth, Parity et autres wallet clients.) ',
...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `gas limit` * le `gas price`. [Vous pouvez convertir GWEI -> XERO ici](https://wallet.ether1.org/helpers.html)',
...
MYWAL_Content_3             : 'SI W’ VLE SÈVI AK BOUS SA  AVÈK XERO Wallet CX NAN LÒT JOU YO, OU DWE METE L’ ANKÒ  SÈVI AK KLE SEKRÈ A /PAJ JSON AK KÒD SEKRÈ A ',
...
TRANS_sendInfo              : 'YON TRANSFÈ NÒMAL SÈVI  AK 21000 GAZ KI KOUTE 0.000441  ETH. PRI GAZ LA 0.000000021 XERO  KE NOU TE CHWAZI A ON TI JAN PI WO KE  PI PITI A ASIRE W’ POU W’ YON KONFIMASYON RAPID. NOU PA PRAN FRÈ POU TRANSFÈ A.  ',
...
SWAP_init_2                 : 'POU ', //M’ VLE CHANJE X XERO POU X BTC '
...
SWAP_progress_3             : ', // XERO Received! XERO RESEVWA ! ',
SWAP_progress_4             : 'VOYE {{REZILTA LÒD. KREYASYON.MONNEN}} YO ',
SWAP_progress_5             : 'LÒD AKONPLI ',
SWAP_order_CTA              : 'TANPRI VOYE 1 XERO ',
SWAP_unlock                 : 'OUVRI BOUS OU A POU W’ VOYE XERO YO OSWA TOKENS YO SÒTI DIRÈKTEMAN NAN SA ',
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : 'SA PÈMÈT OU POU W’ PRAN PLIZYÈ VÈZSYON KLE SEKRÈ  YO EPI AK SÒTI BOUS OU A ANKÒ SOU PAPYE. OU DWE FÈ L’ POU [ PRAN KONT OU A NAN GETH/MIST] (http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). SI W’ VLE  WÈ VALÈ KÒB OU A, NOU MANDE W’ POU SÈVI AK YON EKSPLORATÈ POU BLOCKCHAIN TANKOU[explorer.ether1.org](https://explorer.ether1.org/#/).',
...
ERROR_28                    : '**OU BEZWEN PAJ KEYSTORE W’ LA EPI KÒD SEKRÈ A ** ( OSWA KLE SEKRÈ W’ LA) POU KAPAB ANTRE NAN BOUS SA NAN LÒT JOU YO. TANPRI PRAN L’EPI  POU W’ SERE L’ YON KOTE DEYÒ ! PA GEN OKENN LÒT MWAYEN POU W’ JWENN ANKÒ YON BOUS SI W’ PA ANREJISTRE L’. TANPRI LI PAJ SA [PAJ POU EDE](https://wallet.ether1.org/#help) POU DETAY YO ',
...
TranslatorName_1            : '[Nogo10](https://wallet.ether1.org/?gaslimit=21000&to= 0x152e77CC3Dd8d86471ebEa8e93B9924A41e7055a&value=1.0#VOYE-TRANSFÈ A) · ',
...
HELP_8_Desc_2               : 'SI MYETHERWALLET.COM TONBE, OU DWE JWENN YON LÒT MWAYEN ( TANKOU GXERO OSWA ETHEREUM WALLET / MIST) POU FÈ MENM BAGAY LA. MEN OU PA GEN POU "REPRAN " ETHER W’ LA KI NAN MY ETHERWALLET PASKE L’ PA NAN MY ETHERWALLET. LI LAKAY OU. NAN BOUS SA W’ TE KREYE SOU SIT NOU AN. ',
...
HELP_12_Desc_19             : 'OUVRI YON PÒ EPI KÒMANSE KOMAND KI VINI AN : `GXERO ACCOUNT  IMPORT~/DESKTOP/NOTHING_SPECIAL_DELETE_ME.TXT` ',
HELP_12_Desc_20             : 'SA AP ENVITE CHWAZI YON NOUVO KÒD SEKRÈ. SE SA W’ PRAL ITILIZE NAN GXERO / ETHEREUM WALLET / MIST  NAN CHAK MOMAN OU PRAL FÈ YON TRANSFÈ. KIDONK PA BLIYE L’. ',
...
HELP_12_Desc_25             : 'KÒMANSE AK KÒMAND  `GXERO ACCOUNT IMPORT C:// NOTHING_SPECIAL_DELETE_ME.TXT` ',
HELP_12_Desc_26             : 'SA PRAL ENVITE W’ POU CHWAZI YON NOUVO KÒD SEKRÈ. SE AK SA W’ PRAL SÈVI NA GXERO / ETHEREUM WALLET / MIST CHAK FWA OU PRAL VOYE YON TRANFÈ KIDONK PA BLIYE L’. ',
...
HELP_SecCX_Desc_6           : 'SI NOU TA DWE METE KÒD NAN ENFÒMASYON YO, FÒK OU TA ANTRE YON KÒD SEKRÈ NAN CHAK MOMAN OU BEZWEN WÈ LAJAN SOU KONT OU OSWA LÒT TI NON YO. SI SA NWI W’,NOU MANDE W’ POU SÈVI AK XERO Wallet KE EXTENSION CHROME SA. ',
...
HELP_Sec_Desc_4             : 'VERIFYE URL LA – SIT SA SÈVI AK GITHUB EPI OU KAPAB WÈ KÒD SOUS LA LA : : [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) NAN  [https://wallet.ether1.org](https://wallet.ether1.org). ',
