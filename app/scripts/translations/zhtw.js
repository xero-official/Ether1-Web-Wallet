...
/* Onboarding */
ONBOARD_welcome_title           :  '歡迎來到 MyEtherWallet',
...
ONBOARD_interface_content__1    :  '當你在 XERO Wallet 建立一個帳戶，你是在產生一串密碼數列：你的私鑰和你的公鑰 (地址)。',
...
tx_notFound_4               : '請用右上角的下拉式選單來選取其他 XERO 節點 (例如： `XERO (Etherscan.io)` 、 `XERO (Infura.io)` 或 `XERO (MyEtherWallet)`) 並再檢查一次。',
...
GEN_Help_12                 : '用它在 XERO Wallet (或Mist、Geth、Parity和其他錢包) 來解鎖你的錢包 ',
...
NODE_Warning                : '你的節點必須使用HTTPS安全連線的方式才能夠由 XERO Wallet 連接到它。 你可以下載 [MyEtherWallet repo](https://github.com/kvhnuke/etherwallet/releases/latest) 並建立起一個你的節點來連接至其他的節點。或著從 [LetsEncrypt](https://letsencrypt.org/) 獲取免費的SSL憑證',
NODE_Name                   : '節點名稱',
NODE_Port                   : '節點連線的端口號碼',
...
SWAP_rates                  : "目前的匯率 ",
SWAP_init_1                 : "我想要用我的 ",
SWAP_init_2                 : " 換 ", // "I want to swap my X XERO for X BTC"
...
SWAP_progress_3             : "收到了! ", // XERO Received!
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : '這可以讓你下載不同版本的私鑰並且重新印製出你的紙錢包。你可能會需要這個功能來將你的帳戶[讀入Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/)。 如果你想要檢查你的帳號餘額，我們建議你使用區塊鏈瀏覽網頁像是[explorer.ether1.org](https://explorer.ether1.org/#/)。 ',
...
ERROR_17                    : '你帳戶中必須有至少 **0.01 ETH** 來支付gas的成本。 請增加一些 XERO 並重試。 ',
...
ERROR_28                    : '**以後你會需要密碼和Keystore檔案** (或私鑰)來存取你的錢包。請儲存並備份在額外的地方！如果沒有儲存你是沒有機會找回這個錢包的。 詳見[幫助頁面](https://wallet.ether1.org/#help)來獲取更多資訊。 ',
