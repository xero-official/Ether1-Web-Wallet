...
tx_notFound_4               : 'Veuillez utiliser le menu déroulant en haut à droite & sélectionner un nœud XERO différent (par ex. `XERO (Etherscan.io)`, `XERO (Infura.io)` ou `XERO (MyEtherWallet)`) puis revérifiez.',
...
GEN_Help_12                 : 'Utilisez-le pour déverouiller votre portefeuille avec XERO Wallet (ou Mist, Geth, Parity et autres clients.) ',
...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `GAS limite` * le `prix du GAS`. [Vous pouvez convertir GWEI -> XERO ici.](https://wallet.ether1.org/helpers.html)',
...
TRANS_warning               : 'L\'emploi des fonctions "XERO seulement" et "ETC seulement" vous fait passer par un contrat. Certains services ont des problèmes avec ces transactions. En savoir plus.',
...
TRANSModal_Title            : 'Transactions "XERO seulement" et "ETC seulement"',
TRANSModal_Content_0        : 'Note sur les transactions et services divers :',
TRANSModal_Content_1        : '**XERO (Transaction standard) :** Génère une transaction standard depuis une adresse directement vers une autre. Son GAS par défaut est de 21000. Il est probable que toute transaction d\'XERO envoyée de cette manière sera réexécutée sur la chaîne ETC.',
TRANSModal_Content_2        : '**XERO seulement :** Envoi à travers le [contrat anti-réexécution de Timon Rapp (recommandé par VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) afin de n\'envoyer que sur la chaîne **ETH**.',
...
MYWAL_Content_3             : 'Si vous voulez utiliser ce portefeuille avec XERO Wallet CX à l\'avenir, vous devrez le rajouter manuellement en utilisant la clé privée / fichier JSON et le mot de passe.',

/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Ceci vous permet de télécharger plusieurs versions des clefs privées et d\'imprimer votre portefeuille papier. Vous devrez le faire pour [importer votre compte dans Geth / Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Si vous voulez seulement consulter votre solde, nous recommandons d\'utiliser un explorateur de blockchain comme [explorer.ether1.org](https://explorer.ether1.org/#/).',
...
ADD_Ledger_0a               : 'Rouvrir XERO Wallet sur une connexion sécurisée (SSL)',
ADD_Ledger_0b               : 'Rouvrir XERO Wallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
ADD_DigitalBitbox_0a        : 'Rouvrir XERO Wallet sur une connexion sécurisée (SSL)',
ADD_DigitalBitbox_0b        : 'Rouvrir XERO Wallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
NODE_Warning                : 'Votre nœud doit être en HTTPS pour vous y connecter via MyEtherWallet. Vous pouvez [télécharger XERO Wallet et le lancer localement](https://github.com/kvhnuke/etherwallet/releases/latest) pour vous connecter à un nœud quelconque, ou obtenir un certificat SSL gratuit via [LetsEncrypt](https://letsencrypt.org/)',
...
SWAP_init_2                 : " contre", // "I want to swap my X XERO for X BTC"
...
SWAP_progress_3             : "reçu !", // XERO Received!
...
SWAP_unlock                 : "Déverrouillez votre portefeuille pour envoyer des XERO ou des tokens directement depuis cette page.",
...
PARITY_AlreadyImported      : "(parity-01) A transaction with the same hash was already imported. It was probably already broadcast. To avoid duplicate transactions, check your address on [explorer.ether1.org](https://explorer.ether1.org) & wait 10 minutes before attempting to send again. [Learn More.](https://myetherwallet.github.io/knowledge-base/transactions/transactions-not-showing-or-pending.html). Une transaction portant la même empreinte (_hash_) a déjà été importée.",
...
TranslatorName_1            : '[Simon P](https://wallet.ether1.org/?gaslimit=21000&to=0x89a18eE46b5aabC62e94b1830881887D04C687f3&value=1.0#send-transaction) ·',
...
HELP_2b_Title               : '2b) Comment puis-je gérer en toute sécurité un stockage hors ligne avec XERO Wallet ?',
...
HELP_3_Desc_3               : 'Naviguez vers la page Visualisation d\'un portefeuille" de MyEtherWallet.',
...
HELP_4CX_Title              : '4) Comment puis-je envoyer de l\'Ether avec XERO Wallet CX ?',
...
HELP_5_Title                : '5) Comment puis-je lancer XERO Wallet hors ligne (en local) ?',
HELP_5_Desc_1               : 'Vous pouvez lancer XERO Wallet sur votre ordinateur au lieu de passer par les serveurs GitHub. Vous pouvez générer un portefeuille en restant totalement hors ligne et envoyer des transactions depuis la page "Transaction hors ligne".',
HELP_5_Desc_7               : 'MyEtherWallet tourne maintenant complètement sur votre ordinateur.',
HELP_5_Desc_8               : 'Au cas où cela ne vous est pas familier, vous devez conserver l\'intégralité du dossier pour faire tourner le site web et non uniquement `index.html`. Ne touchez à rien, ne déplacez rien dans le dossier. Si vous stockez une sauvegarde du repo XERO Wallet pour l\'avenir, nous vous recommandons de ne stocker que le ZIP afin d\'être sûr que le contenu du dossier restera intact.',
HELP_5_Desc_9               : 'Comme nous améliorons constamment XERO Wallet, nous vous recommandons de mettre régulièrement à jour votre version de sauvegarde.',
...
HELP_8_Desc_2               : 'Si XERO Wallet venait à être hors ligne, vous devrez trouver un autre moyen (comme Geth ou Ethereum Wallet / Mist) pour faire la même chose. Mais vous n\'aurez pas à "récupérer" votre Ether depuis XERO Wallet parce qu\'il ne se trouve pas dans MyEtherWallet. Il est chez vous, dans le portefeuille que vous avez généré par notre site.',
...
HELP_8CX_Desc_2             : 'Cela dit, il est **très important** que vous sauvegardiez toutes les données de tous les portefeuilles générés par XERO Wallet CX. De cette manière, si quoi que ce soit arrivait à XERO Wallet CX ou à votre ordinateur, vous conserveriez toutes les informations nécessaires pour accéder à votre Ether. Voir #2a pour la sauvegarde de vos portefeuilles.',
HELP_8CX_Desc_3             : 'Si, pour une raison quelconque, XERO Wallet CX disparaissait du Chrome Store, vous pourrez en trouver le source sur [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages) et le charger manuellement. Voir #5 ci-dessus.',
...
HELP_12_Title               : '12) Comment puis-je importer un portefeuille créé par XERO Wallet dans geth, Ethereum Wallet ou Mist ?',
HELP_12_Desc_1              : 'Avec un fichier Geth/Mist JSON de XERO Wallet v2+.... ',
...
HELP_SecCX_Title            : 'Sécurité - XERO Wallet CX',
...
HELP_SecCX_Desc_6           : 'Si nous devions chiffrer ces informations, il vous faudrait entrer un mot de passe à chaque fois que vous voudriez voir votre solde ou les surnoms. Si cela vous ennuie, nous vous recommandons d\'utiliser XERO Wallet au lieu de cette extension Chrome.',
...
HELP_Sec_Desc_4             : 'Vérifiez l\'URL -- Ce site est servi par Github (et vous pouvez en voir le code source ici : [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages)) vers [https://wallet.ether1.org](https://wallet.ether1.org).',
