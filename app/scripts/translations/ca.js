...
tx_notFound_4               : 'Utilitza el menú desplegable a la part superior dreta i selecciona un node XERO diferent (p. Ex. `XERO (Etherscan.io)` o `XERO (Infura.io)` o `XERO (MyEtherWallet)`)  i torna-ho a comprovar.',
...
tx_FoundOnChain_3           : '**Si no veus cap error, la teva transacció s\'ha enviat amb èxit.** El teu XERO o Tokens són on els has enviat. Si no pots veure aquest XERO o Tokens a la teva cartera / compte de bescanvi, i han passat més de 24 hores des de l\'enviament, si us plau [contacta amb aquest servei](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Envia *l\'enllaç* de la teva transacció si demana amablement que investiguin.',
...
GEN_Help_12                 : 'Utilitza\'l per desbloquejar la teva cartera amb XERO Wallet (o Mist, Geth, Parity i altres clients de carteres.) ',
...
GAS_LIMIT_Desc              : 'El límit de gas és la quantitat de gas a enviar amb la teva TX. `TX fee` = preu del gas * límit de gas; i es paga als miners per incloure la teva TX a un block. Incrementat aquest nombre no farà que la teva TX sigui minada més ràpidament. Enviant XERO = `21000`. Enviant Tokens = ~`200000`.',
...
TXFEE_Desc                  : 'La comissió per la TX es paga als miners per incloure la teva TX en un block. És el `límit de gas` * `preu del gas`. [Pots convertir GWEI -> XERO aquí](https://wallet.ether1.org/helpers.html)',
...
ADD_Ledger_0a               : 'Has d\'accedir a XERO Wallet utilitzant una connexió segura (SSL / HTTPS). ',
ADD_Ledger_0b               : 'Torna a obrir XERO Wallet utilitzant [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Torna a obrir XERO Wallet utilitzant una connexió segura (SSL) ',
ADD_DigitalBitbox_0b        : 'Torna a obrir XERO Wallet utilitzant [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Si vols utilitzar aquesta cartera amb XERO Wallet CX en el futur, hauràs de tornar a afegir-la manualment utilitzant la clau privada/JSON i contrasenya. ',
...
TRANS_sendInfo              : 'Una transacció estàndard utilitzant 21000 gas costarà 0.000441 ETH. Utilitzem un preu una mica per sobre del mínim de 0.000000021 XERO per assegurar que es mina ràpidament. No ens quedem cap comissió per la transacció. ',
...
NODE_Warning                : 'El teu node ha de ser HTTPS per tal de poder-t\'hi connectar utilitzant MyEtherWallet. Pots [descarregar-te el repo de XERO Wallet i executar-lo localment](https://github.com/kvhnuke/etherwallet/releases/latest) per connectar-te a qualsevol node. O, obtén un certificat SSSL gratuït amb [LetsEncrypt](https://letsencrypt.org/)',
...
SWAP_init_2                 : " per ", // "I want to swap my X XERO for X BTC"
...
SWAP_progress_3             : "Rebut! ", // XERO Received!
...
SWAP_unlock                 : "Desbloqueja la teva cartera per enviar XERO o Tokens directament des d\'aquesta pàgina ",
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Això et permet descarregar diferents versions de les claus privades i tornar a imprimir la teva cartera de paper. És possible que vulguis fer això per [importar el teu compte a Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Si vols comprovar el teu saldo, recomanem utilitzar un explorador de la blockchain com [explorer.ether1.org](https://explorer.ether1.org/#/). ',
