...
ENS_Helper_4                    :  'Decide the maximum amount of XEROM you are willing to pay for the name (your <u>Bid Amount</u>). Ensure that account has enough to cover your bid + 0.01 XEROM for gas.',
...
ONBOARD_interface_content__6    :  'If you send your *public key (address)* to someone, they can send you XEROM or tokens. 👍',
...
tx_notFound_4               : 'Utilizza il menu a discesa in alto a destra e scegli un altro nodo XEROM (ad esempio `XEROM (Etherscan.io)` o `XEROM (Infura.io)` o `XEROM (MyEtherWallet)`) e ricontrolla.',
...
tx_FoundOnChain_3           : '**Se non vedi errori, la transazione è stata inviata correttamente.** I tuoi XEROM o i tuoi token sono dove li hai inviati. Se non vedi questi XEROM o token nell\'altro portafoglio / nel conto della piattaforma di scambio, e se sono passate più di 24 ore dall\'invio, [contatta quel servizio esterno](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Invia loro il *link* alla transazione e chiedi, cortesemente, di controllare la tua situazione.',
...
GEN_Help_12                 : 'Usalo per sbloccare il portafoglio tramite XERO Wallet (o Mist, Geth, Parity e altri client.) ',
...
TXFEE_Desc                  : 'La commissione transazione si paga ai *miner* perché includano la transazione in un blocco. Si calcola come `limite gas` * `prezzo gas`. [Puoi calcolare la conversione GWEI -> XEROM qui](https://wallet.ether1.org/helpers.html)',
...
TRANS_sendInfo              : 'Una transazione standard che utilizza 21000 gas costerà 0,000441 ETH. Utilizziamo un prezzo del gas leggermente al di sopra del minimo pari a 0,000000021 XEROM per assicurarci che venga elaborata velocemente. Noi non prendiamo commissioni. ',
...
MYWAL_Content_3             : 'Se vorrai utilizzare questo portafoglio con XERO Wallet CX in futuro, dovrai ri-aggiungerlo manualmente tramite la chiave privata/JSON e password. ',

/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Qui è possibile scaricare diverse versioni delle chiavi private e ristampare il portafoglio cartaceo. Potresti volerlo fare per  [importare il tuo conto in Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Se vuoi controllare il tuo saldo, ti consigliamo di utilizzare uno strumento per esplorare la *blockchain* come [explorer.ether1.org](https://explorer.ether1.org/#/). ',
...
ADD_Ledger_0a               : 'Devi accedere a XERO Wallet tramite una connessione sicura (SSL / HTTPS) per poterti collegare. ',
ADD_Ledger_0b               : 'Riapri XERO Wallet utilizzando [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Riapri XERO Wallet su una connessione sicura (SSL) ',
ADD_DigitalBitbox_0b        : 'Riapri XERO Wallet utilizzando [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
NODE_Warning                : 'Il tuo nodo deve utilizzare HTTPS per potertici collegare da MyEtherWallet. Puoi [scaricare il repository di XERO Wallet ed eseguirlo in locale](https://github.com/kvhnuke/etherwallet/releases/latest) per collegarti ad altri tipi di nodo. Oppure, ottieni un certificato SSL gratuito tramite [LetsEncrypt](https://letsencrypt.org/)',
...
SWAP_init_2                 : " per ", // "I want to swap my X XEROM for X BTC"
...
SWAP_progress_3             : "ricevuti! ", // XEROM Received!
...
SWAP_unlock                 : "Sblocca il tuo portafoglio per inviare XEROM o token direttamente da questa pagina. ",
...
ERROR_17                    : 'L\'account dal quale stai provando ad inviare la transazione non ha abbastanza fondi. Se stai inviando token, ti servono 0,01 XEROM nel conto per coprire i costi del gas. ',
...
TranslatorName_1            : '[ugilio](https://wallet.ether1.org/?gaslimit=21000&to=0x07932bc1c68c8ff188f4225e892178ab6d8c4eaa&value=1.0#send-transaction) ',
...
HELP_3_Desc_3               : 'Vai alla pagina "Informazioni portafoglio" su MyEtherWallet. ',
...
HELP_4CX_Title              : '4) Come invio degli ether utilizzando XERO Wallet CX? ',
...
HELP_5_Title                : '5) Come faccio ad eseguire XERO Wallet offline/in locale? ',
HELP_5_Desc_1               : 'Puoi eseguire XERO Wallet sul tuo computer invece che dai server di GitHub. Puoi generare un portafoglio completamente offline e inviare transazioni dalla pagina "Invia Offline". ',
HELP_5_Desc_7               : 'MyEtherWallet è ora in esecuzione completamente sul tuo computer. ',
HELP_5_Desc_8               : 'In caso tu non abbia molta confidenza, ti serve l\'intera cartella per poter eseguire il sito web, non solo `index.html`. Non toccare né spostare nulla del contenuto della cartella. Se stai conservando un backup del repository XERO Wallet per il futuro, ti consigliamo di conservare soltanto il file ZIP in modo da assicurarti che i contenuti della cartella rimangano intatti. ',
HELP_5_Desc_9               : 'Dal momento che stiamo costantemente aggiornando XERO Wallet, ti consigliamo di aggiornare periodicamente la tua versione locale del repository. ',
...
HELP_8_Desc_2               : 'Se XERO Wallet va giù, dovrai trovare un altro modo (come geth o Ethereum Wallet / Mist) per fare quello che facciamo noi. Ma non dovrai "tirare fuori" i tuoi ether da XERO Wallet perché non si trovano in MyEtherWallet. Sono in qualunque portafoglio tu abbia generato tramite il nostro sito. ',
...
HELP_8_Desc_4               : 'Inoltre, la probabilità che tiriamo giù XERO Wallet è prossima allo zero. Non ci costa praticamente nulla mantenerlo dal momento che non stiamo memorizzando alcuna informazione. Se anche disattivassimo il dominio, è ancora, e sarà sempre, disponibile pubblicamente su [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Puoi scaricare lo ZIP da lì ed eseguirlo in locale. ',

HELP_8CX_Title              : '8) Che succede se XERO Wallet CX sparisce? ',
...
HELP_8CX_Desc_2             : 'Detto ciò, è **molto importante** che tu faccia un backup di tutte le informazioni relative a ogni nuovo portafoglio generato con XERO Wallet CX. In questo modo se succede qualcosa a XERO Wallet CX or al tuo computer avrai ancora tutte le informazioni necessarie ad accedere ai tuoi ether. Vedi la domanda n. 2a per come salvare i tuoi portafogli. ',
HELP_8CX_Desc_3             : 'Se per qualche ragione XERO Wallet CX sparisce dal Chrome Store, puoi trovare i sorgenti su Github e caricare l\'estensione manualmente. Vedi la domanda n. 5 qui sopra. ',
...
HELP_12_Title               : '12) Come faccio a importare un portafoglio creato con XERO Wallet in geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Con un file JSON Geth/Mist generato da XERO Wallet v2+.... ',
...
HELP_14_Title               : '14) Certi siti inizializzano il generatore di numeri casuali per la generazione della chiave privata tramite i movimenti del mouse. XERO Wallet non lo fa. La generazione di numeri casuali di XERO Wallet è sicura? ',
HELP_14_Desc_1              : 'Sebbene usare i movimenti del mouse sia ingegnoso, e comprendiamo perché piaccia, la realtà è che window.crypto assicura maggiore entropia rispetto ai tuoi movimenti del mouse. Non che i movimenti del mouse siano insicuri, è solo che noi (e un sacco di altri critto-esperimenti) crediamo in window.crypto. Oltretutto, XERO Wallet può essere utilizzato su dispositivi touch. Qui c\'è una [conversazione fra un utente di reddit arrabbiato e Vitalik Buterin su movimenti del mouse contro window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) e qui c\'è [la specifica del w3 di window.crypto](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title            : 'Sicurezza - XERO Wallet CX ',
...
HELP_SecCX_Desc_6           : 'Se crittografassimo questi elementi dovresti inserire una password ogni volta in cui volessi vedere il saldo del tuo conto o i nomi dei portafogli. Se ciò ti preoccupa, ti consigliamo di usare XERO Wallet invece di questa estensione di Chrome. ',
...
HELP_Sec_Desc_4             : 'Controlla l\'URL -- Questo sito viene servito attraverso GitHub e puoi vederne il codice sorgente qui: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) su [https://wallet.ether1.org](https://wallet.ether1.org). ',
