...
tx_notFound_4               : 'Por favor usa el desplegable en la parte superior derecha y selecciona un nodo XERO diferente (ej. `XERO (Etherscan.io)` o `XERO (Infura.io)` o `XERO (MyEtherWallet)`) y comprueba de nuevo.',
...
TRANSModal_Content_1        : '**XERO (transacción estándar): ** Esto genera una transacción predeterminada directamente de una dirección a otra. Utiliza gas predeterminado de 21000. Es probable que cualquier transacción de XERO enviada mediante este método se reproduzca (replay) en la cadena ETC. ',
...
MYWAL_Content_3             : 'Si en el futuro quieres utilizar esta cartera con XERO Wallet CX, tendrás que volver a añadirla manualmente utilizando Clave Privada/JSON y contraseña. ',

/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Esto te permite descargar múltiples versiones de claves privadas e imprimir de nuevo tu cartera en papel. Puede que te interese hacer esto para [importar tu cuenta en Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Si quieres comprobar tu saldo, recomendamos utilizar un explorador de blockchain como [explorer.ether1.org](https://explorer.ether1.org/#/). ',
...
NODE_Warning                : 'Tu nodo debe ser HTTPS para poder conectar a él desde MyEtherWallet. Para conectarte a cualquier nodo, puedes [descargar el repositorio de XERO Wallet y ejecutarlo localmente](https://github.com/kvhnuke/etherwallet/releases/latest). También puedes conseguir un certificado SSL gratuito a través de [Let\'s Encrypt](https://letsencrypt.org/)',
...
SWAP_init_2                 : " por ", // "I want to swap my X XERO for X BTC"
...
SWAP_progress_3             : "¡Recibido! ", // XERO Received!
...
SWAP_unlock                 : "Desbloquea tu cartera para enviar XERO o tokens directamente desde esta página. ",
...
ADD_Ledger_0a               : 'Volver a abrir XERO Wallet en una conexión segura (SSL) ',
ADD_Ledger_0b               : 'Volver a abrir XERO Wallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) u [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Volver a abrir XERO Wallet en una conexión segura (SSL) ',
ADD_DigitalBitbox_0b        : 'Volver a abrir XERO Wallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) u [Opera](https://www.opera.com/) ',
...
ERROR_28                        :  '(error_29) **Necesitas tu archivo Keystore/JSON y la contraseña** (o clave privada) para acceder a esta cartera en el futuro. Por favor ¡guárdala y respáldala externamente! No hay modo de recuperar una cartera si no la guardas. Lee la [página de ayuda](https://wallet.ether1.org/#help) para instrucciones. You need this `Keystore File + Password` or the `Private Key` (next page) to access this wallet in the future. ', // 28
...
HELP_3_Desc_3               : 'Ve a la página "Ver Información de las Carteras" de MyEtherWallet. ',
...
HELP_4CX_Title              : '4) ¿Cómo envío ether utilizando XERO Wallet CX? ',
...
HELP_5_Title                : '5) ¿Cómo ejecuto XERO Wallet sin conexión/localmente? ',
HELP_5_Desc_1               : 'Puedes ejecutar XERO Wallet en tu equipo en lugar de desde los servidores de GitHub. Puedes generar una cartera totalmente sin conexión y enviar transacciones desde la página "Transacción sin conexión". ',
HELP_5_Desc_7               : 'XERO Wallet is now running entirely on your computer. ',
HELP_5_Desc_8               : 'Por si no tienes costumbre, es necesario guardar la carpeta completa para ejecutar la página web, no solamente `index.html`. No modifiques ni muevas nada dentro de la carpeta. Si estás guardando una copia del repositorio XERO Wallet para el futuro, recomendamos guardar únicamente el fichero ZIP para poder estar seguro de que el contenido permanezca intacto. ',
HELP_5_Desc_9               : 'Debido a que estamos constantemente actualizando XERO Wallet, recomendamos que actualices periódicamente tu versión guardada del repositorio. ',
...
HELP_8_Desc_2               : 'Si XERO Wallet desapareciera, tendrías que encontrar otra manera de poder hacer lo que haces con nosotros (como por ejemplo obtener geth o Ethereum Wallet / Mist). Pero no necesitarías retirar tus ether de XERO Wallet porque no están en MyEtherWallet. Están en la cartera que hayas generado a través de nuestro sitio. ',
...
HELP_8_Desc_4               : 'Además, la probabilidad de que cerremos XERO Wallet es casi nula. No nos cuesta prácticamente nada mantenerlo ya que no almacenamos ninguna información. Si borramos el dominio, continúa estando disponible y siempre lo estará en [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Puedes descargar desde ahí el archivo ZIP y ejecutarlo localmente. ',

HELP_8CX_Title              : '8) ¿Qué ocurre si XERO Wallet CX desaparece? ',
...
HELP_8CX_Desc_2             : 'Dicho esto, es **muy importante** que respaldes toda tu información para todas las nuevas carteras generadas con XERO Wallet CX. De este modo, si algo le ocurre a XERO Wallet CX o a tu equipo, seguirás teniendo toda la información necesaria para poder acceder a tus ether. Ver la pregunta #2a sobre cómo respaldar tus carteras. ',
HELP_8CX_Desc_3             : 'Si por algún motivo XERO Wallet CX desaparece de Chrome Store, puedes encontrar el código fuente en Github y cargarlo manualmente. Ver #5 más arriba. ',
...
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experments) believe in window.crypto. In addition, XERO Wallet can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_16_Desc_1              : 'You can use a blockchain explorer like [explorer.ether1.org](https://explorer.ether1.org/#/). Paste your address into the search bar and it will pull up your account and transaction history. For example, here\'s what our [donation account](https://explorer.ether1.org/addr/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) looks like on explorer.ether1.org ',
...
HELP_SecCX_Title            : 'Seguridad - XERO Wallet CX ',
...
HELP_SecCX_Desc_6           : 'Si cifráramos estos ítems, sería necesario que introduzcas una contraseña cada vez que quisieras comprobar el saldo de tu cuenta o vizualizar los alias. Si esto te preocupa, te recomendamos que utilices XERO Wallet en lugar de esta extensión de Chrome. ',
...
HELP_Sec_Desc_4             : 'Comprueba la URL -- Este sitio se sirve a través de GitHub y puedes ver el código fuente aquí: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) a [https://wallet.ether1.org](https://wallet.ether1.org). ',
