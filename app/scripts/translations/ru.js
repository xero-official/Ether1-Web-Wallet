...
NODE_Warning                : 'Ваш узел должен использовать протокол HTTPS, чтобы XERO Wallet мог с ним работать. Вы можете [скачать репозиторий XERO Wallet & и запустить его локально](https://github.com/kvhnuke/etherwallet/releases/latest) чтобы иметь возможность работать с любыми узлами, или получите бесплатный SSL сертификат на [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Имя узла',
NODE_Port                   : 'Порт узла',
...
SWAP_init_2                 : " на ", // "I want to swap my X XERO for X BTC"
...
SWAP_progress_3             : "Получено! ", // XERO Received!
...
SWAP_unlock                 : "Отоприте ваш кошелёк для отправки XERO или Tokens непосредственно с этой страницы. ",
...
ADD_Ledger_0a               : 'Перезапустите XERO Wallet через безопасное (SSL) соединение ',
ADD_Ledger_0b               : 'Перезапустите XERO Wallet с браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Перезапустите XERO Wallet через безопасное (SSL) соединение ',
ADD_DigitalBitbox_0b        : 'Перезапустите XERO Wallet с браузере [Chrome](https://www.google.com/chrome/browser/desktop/) или [Opera](https://www.opera.com/) ',
...
TranslatorName_1            : '[Михаил Владимиров](https://wallet.ether1.org/?gaslimit=21000&to=0x6ff323e36bfdb20502b23780695f4e77e36cde95&value=1.0#send-transaction) ',
