...
ENS_Helper_4                    :  'Tentukan jumlah maksimum XEROM yang bersedia Anda bayar untuk nama tersebut (<u>Bid Amount</u> Anda). Pastikan akun memiliki cukup dana untuk membayar tawaran Anda + 0.01 XEROM untuk gas.',
...
/* Onboarding */
ONBOARD_welcome_title           :  'Selamat datang di MyEtherWallet',
...
ONBOARD_welcome_content__6      :  'XERO Wallet memungkinkan Anda untuk berinteraksi langsung dengan blockchain sambil tetap memegang kendali penuh atas kunci &amp; dana Anda.',
...
ONBOARD_interface_content__1    :  'Saat membuat akun di XERO Wallet, Anda menghasilkan kumpulan nomor kriptografi: Kunci Privat dan kunci publik (alamat) Anda.',
...
ONBOARD_interface_content__6    :  'Jika Anda mengirim *kunci publik (alamat)* kepada seseorang, mereka dapat mengirimkan XEROM atau token. 👍',
...
ONBOARD_bank_title__alt         :  'XERO Wallet bukan sebuah Bank',
...
ONBOARD_blockchain_content__4   :  'Blok di blockchain berisi catatan dari semua transaksi individual yang dikirim dari XERO Wallet, MetaMask, Exodus, Mist, Geth, Parity, dan lain-lainnya..',
ONBOARD_blockchain_content__5   :  'Saat Anda melihat saldo di XERO Wallet atau melihat transaksi Anda di [explorer.ether1.org](https://explorer.ether1.org), Anda melihat data di blockchain, bukan di sistem privat Anda.',
ONBOARD_blockchain_content__6   :  'Sekali lagi: **kami bukan sebuah bank**.',
ONBOARD_interface_title__alt    :  'XERO Wallet adalah sebuah antarmuka',
...
ONBOARD_blockchain_title__alt   :  'Apa itu Blockchain?',
ONBOARD_point_title__alt        :  'Jadi apa gunanya XERO Wallet kalau begitu?',
ONBOARD_whymew_title            :  'Jika XERO Wallet tidak dapat melakukan semua hal tersebut, lalu apa gunanya?',
...
ONBOARD_whymew_content__6       :  'Jika Anda takut tapi ingin menggunakan XERO Wallet, [gunakan dompet hardware](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! Perangkat ini akan menjaga kunci Anda tetap aman.',
...
ONBOARD_secure_1_content__1     :  'Phisher biasanya mengirim Anda pesan dengan link ke situs web yang sekilas terlihat seperti XERO Wallet, EtherDelta, Paypal, atau bank Anda, namun bukan situs web yang asli. Mereka mencuri informasi Anda dan kemudian mencuri uang Anda.',
...
ONBOARD_secure_1_content__3     :  'Selalu periksa URLnya: `https://wallet.ether1.org`.',
ONBOARD_secure_1_content__4     :  'Pastikan bar URL menunjukkan `ETHER-1` dalam warna hijau.',
...
ONBOARD_final_content__3        :  'Cara Setup XERO Wallet + MetaMask',
ONBOARD_final_content__4        :  'Cara Menjalankan XERO Wallet Offline / Lokal',
...
tx_notFound_4               : 'Gunakan dropdown di kanan atas & pilih node XEROM lainnya (e.g. `XEROM (Etherscan.io)` atau `XEROM (Infura.io)` atau `XEROM (MyEtherWallet)`) dan check kembali.',
...
GEN_Help_12                 : 'Pakailah untuk membuka dompet Anda melalui XERO Wallet (atau Mist, Geth, Parity maupun perangkat lunak dompet lainnya.) ',
...
GAS_LIMIT_Desc              : 'Batas Gas (Gas limit) adalah jumlah gas untuk dikirim bersama TX Anda.  `Biaya TX = harga gas * gas limit` & dibayarkan kepada miners untuk memasukkan TX Anda ke dalam block. Menaikkan angka ini tidak mempercepat TX Anda untuk ditambang. Pengiriman XEROM = `21000`. Pengiriman Token = ~`200000`.',
...
ADD_Ledger_0a               : 'Buka kembali XERO Wallet melalui koneksi (SSL) yang aman ',
ADD_Ledger_0b               : 'Buka kembali XERO Wallet menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Buka kembali XERO Wallet melalui koneksi (SSL) yang aman ',
ADD_DigitalBitbox_0b        : 'Buka kembali XERO Wallet menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
TRANS_data                  : 'Data ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'Transaksi standar menggunakan 21000 gas membutuhkan 0.000441 ETH. Kami memakai harga gas sedikit-diatas-harga-gas-minimum senilai 0.000000021 XEROM untuk mempercepat. Kami tidak mengambil biaya atas transaksi. ',

/* Send Transaction Modals */
TRANSModal_Title            : 'Transaksi "Hanya ETH" dan "Hanya ETC" ',
TRANSModal_Content_0        : 'Catatan terkait jenis transaksi dan layanan: ',
TRANSModal_Content_1        : '**XEROM (Transaksi Standar): ** Transaksi default ini melakukan pengiriman langsung dari alamat pengirim ke alamat tujuan. Nilai Gas 21000. Besar kemungkinan XEROM yang dikirim dengan metode ini akan di "replay" di rantai ETC. ',
...
MYWAL_Content_3             : 'Jika Anda akan memakai dompet ini dengan XERO Wallet CX Anda ke depan, Kunci Privat/JSON dan password harus ditambahkan lagi secara manual. ',

/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Memungkinkan Anda untuk mencetak Dompet Kertas dari berbagai format atau versi Kunci Privat. Hal ini diperlukan pada saat anda ingin [mengimpor akun Anda ke Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Jika Anda hanya ingin pengecekan saldo, pakailah salah satu layanan blockchain explorer seperti [explorer.ether1.org](https://explorer.ether1.org/#/). ',
...
NODE_Warning                : 'Node Anda harus berupa HTTPS untuk dapat terhubung melalui MyEtherWallet. Anda dapat [mengunduh XERO Wallet repo & menjalankannya secara lokal](https://github.com/kvhnuke/etherwallet/releases/latest) untuk terhubung ke node apa saja. Atau, dapatkan SSL certificate gratis melalui [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Nama Node',
NODE_Port                   : 'Port Node',
...
SWAP_init_2                 : " menjadi ", // "I want to swap my X XEROM for X BTC"
...
SWAP_progress_3             : "Diterima! ", // XEROM Received!
...
SWAP_unlock                 : "Unlock wallet Anda untuk mengirim XEROM atau Token langsung dari halaman ini. ",
...
ERROR_28                    : '**DIPERLUKAN File Keystore & password** (atau Kunci Privat) untuk mengakses dompet Anda. Simpan dan backup dengan baik file ini! Tidak ada mekanisme untuk me-recover dompet jika file-nya hilang. Baca instruksi lengkapnya [di sini](https://wallet.ether1.org/#help). ',
...
TranslatorName_1            : '[Yos Ginting](https://wallet.ether1.org/?gaslimit=21000&to=0x8F646C5c215be6E0163f02Bd2eB97AFC2DF70e5c&value=1.0#send-transaction) ',
...
HELP_Remind_Desc_1          : '** Ethereum, XERO Wallet & XERO Wallet CX, dan beberapa library Javascript yang kami gunakan sedang dalam pengembangan yang aktif.** Meskipun kami telah benar-benar menguji & puluhan ribu dompet telah berhasil diciptakan oleh para pengguna di seluruh dunia, selalu ada kemungkinan bahwa sesuatu yang tidak terduga dapat terjadi yang menyebabkan XEROM Anda hilang. Tolong jangan menginvestasikan lebih dari yang Anda mampu kehilangan, dan mohon berhati-hati. Jika ada sesuatu yang buruk terjadi, kami mohon maaf, tapi **kami tidak bertanggung jawab atas Ether yang hilang**. ',
HELP_Remind_Desc_2          : 'MyEtherWallet & XERO Wallet CX bukan "dompet web". Anda tidak membuat akun atau memberikan Ether Anda untuk kami pegang. Semua data tidak pernah meninggalkan komputer/browser Anda. Kami mempermudah Anda untuk membuat, menyimpan, dan mengakses informasi Anda dan berinteraksi dengan blockchain. ',
...
HELP_3_Desc_3               : 'Buka laman XERO Wallet bagian "Lihat Info Dompet" . ',
...
HELP_4CX_Title              : '4) Bagaimana cara mengirim Ether menggunakan XERO Wallet CX? ',
...
HELP_5_Title                : '5) Bagaimana cara menjalankan XERO Wallet secara offline/lokal? ',
HELP_5_Desc_1               : 'Anda dapat menjalankan XERO Wallet secara lokal di komputer Anda, bukan dari server GitHub. Anda dapat membuat dompet yang benar-benar offline dan mengirim transaksi dari laman "Transaksi Offline". ',
HELP_5_Desc_7               : 'MyEtherWallet sekarang berjalan sepenuhnya di komputer Anda. ',
HELP_5_Desc_8               : 'Jika Anda belum pernah melakukannya, Anda harus menyimpan folder dan seluruh isinya (bukan hanya `index.html`) agar bisa menjalankan websitenya. Jangan rubah atau pindahkan file apapun yang ada di dalam folder. Jika Anda akan menyimpan backup dari XERO Wallet repo, sebaiknya simpan versi ZIP-nya untuk menggaransi bahwa isi foldernya lengkap. ',
HELP_5_Desc_9               : 'Karena kami masih terus memperbarui XERO Wallet, sebaiknya Anda juga memperbarui versi repo yang Anda simpan secara berkala. ',
...
HELP_8_Desc_2               : 'Jika situs XERO Wallet tidak berfungsi, Anda harus memakai cara lain (misalnya memakai geth atau Ethereum Wallet/Mist) sebagai alternatifnya. Tapi Anda tidak perlu "mengeluarkan" Ether Anda dari XERO Wallet karena Ether Anda tidak disimpan di MyEtherWallet. Ether Anda tetap tersimpan dalam dompet yang Anda buat di situs kami. ',
...
HELP_8CX_Desc_2             : 'terlepas dari semua itu, **sangat penting** bagi Anda untuk membuat backup/cadangan dari semua informasi dompet baru yang Anda buat dengan XERO Wallet CX. Dengan begitu, jika terjadi sesuatu pada XERO Wallet CX atau komputer Anda, Anda masih memiliki semua informasi yang diperlukan untuk mengakses Ether Anda. Lihat #2a untuk cara membuat backup/cadangan dompet Anda. ',
HELP_8CX_Desc_3             : 'Jika karena suatu hal maupun lainnya XERO Wallet CX tidak lagi tersedia di Chrome Store, Anda tetap dapat menemukan file aslinya di Github dan menjalankannya secara manual. Lihat #5 di atas. ',
...
HELP_12_Title               : '12) Bagaimana cara mengimpor dompet yang dibuat dengan XERO Wallet ke dalam geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Memakai file Geth/Mist JSON yang dibuat dari XERO Wallet v2+.... ',
...
HELP_SecCX_Title            : 'Keamanan - XERO Wallet CX ',
...
HELP_SecCX_Desc_6           : 'Jika kami mengenkripsi item ini, Anda harus memasukkan password setiap kali Anda ingin melihat saldo akun atau melihat nickname. Jiak Anda khawatir, kami sarankan Anda menggunakan XERO Wallet, bukan Chrome Extension ini. ',
...
HELP_Sec_Desc_4             : 'Periksa URL ini -- Situs ini dijalankan melalui GitHub dan Anda bisa melihat sorce code nya di sini: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) ke [https://wallet.ether1.org](https://wallet.ether1.org). ',
