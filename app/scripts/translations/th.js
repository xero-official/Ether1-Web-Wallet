...
tx_notFound_4               : 'กรุณาใช้กล่อง dropdown ที่มุมขวาบน & เลือก XERO Node อื่น (เช่น `XERO (Etherscan.io)` หรือ `XERO (Infura.io)` หรือ `XERO (MyEtherWallet)`) และตรวจสอบอีกครั้ง',
...
GEN_Help_12                 : 'ใช้เพื่อปลดล็อกกระเป๋าของคุณผ่าน XERO Wallet (หรือ Mist, Geth, Parity หรือโปรแกรมกระเป๋าอื่นๆ) ',
...
GAS_LIMIT_Desc              : 'จำนวนจำกัดแก๊ส คือปริมาณของแก๊สที่จะส่งไปกับธุรกรรม (TX) ของคุณ `ค่าธรรมเนียม TX = ราคาแก๊ส * จำนวนจำกัดแก๊ส` และจะถูกจ่ายให้กับผู้ขุดที่ขุด TX ของคุณลงในบล็อค การเพิ่มจำนวนนี้จะไม่ทำให้ TX ของคุณถูกขุดสำเร็จไวขึ้น การส่ง XERO = `21000` หากส่ง Token = ~`200000`',
...
TXFEE_Desc                  : 'ค่าธรรมเนียมธุรกรรม (TX) จะถูกจ่ายให้กับผู้ขุดที่ขุด TX ของคุณลงในบล็อค มีค่าเท่ากับ `จำนวนจำกัดแก๊ส` * `ราคาแก๊ส` [คุณสามารถแปลง GWEI -> XERO ได้ที่นี่](https://wallet.ether1.org/helpers.html)',
...
ADD_Ledger_0a               : 'คุณต้องเข้าใช้ XERO Wallet ผ่านทางการเชื่อมต่อที่ปลอดภัย (SSL / HTTPS) ถึงจะสามารถเชื่อมต่อได้ ',
ADD_Ledger_0b               : 'เปิด XERO Wallet อีกครั้งด้วย [Chrome](https://www.google.com/chrome/browser/desktop/) หรือ [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'เปิด XERO Wallet อีกครั้งผ่านการเชื่อมต่อที่ปลอดภัย (SSL) ',
ADD_DigitalBitbox_0b        : 'เปิด XERO Wallet อีกครั้งด้วย [Chrome](https://www.google.com/chrome/browser/desktop/) หรือ [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'ถ้าหากคุณต้องการจะใช้กระเป๋านี้ร่วมกับ XERO Wallet CX ในอนาคต คุณจำเป็นจะต้องเพิ่มกระเป๋าใหม่อีกครั้งด้วย private key/JSON และรหัสผ่าน ',
...
TRANS_sendInfo              : 'ธุรกรรมโดยทั่วไปจะใช้ค่าแก๊สจำนวน 21000 แก๊ส ซึ่งมีมูลค่าเท่ากับ 0.000441 XERO เราจะใช้ค่าแก๊สที่สูงกว่าทั่วไปอีก 0.000000021 XERO เพื่อทำให้แน่ใจว่าธุกรรมถูกขุดอย่างรวดเร็ว เราไม่ได้เป็นผู้รับค่าธรรมเนียมในการทำธุรกรรม ',
...
NODE_Warning                : 'Node ของคุณจะต้องเป็น HTTPS เพื่อที่จะเชื่อมต่อกับ XERO Wallet คุณสามารถ [ดาวน์โหลดซอร์สโค้ดจาก XERO Wallet repo & รันบนเครื่องคอมพิวเตอร์ของคุณ](https://github.com/kvhnuke/etherwallet/releases/latest) เพื่อเชื่อมต่อกับ Node ใดๆ หรือสร้างใบรับรอง SSL ผ่าน [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'ชื่อ Node',
...
SWAP_init_2                 : " ของฉันด้วย ", // "I want to swap my X XERO for X BTC"
...
SWAP_progress_3             : "ได้รับแล้ว! ", // XERO Received!
...
SWAP_unlock                 : "ปลดล็อกกระเป๋าของคุณเพื่อส่ง XERO หรือ Token ได้โดยตรงจากหน้านี้ ",
...
ERROR_17                    : 'มียอดคงเหลือไม่พอในบัญชีที่คุณกำลังจะส่งออก ถ้าหากคุณกำลังจะส่ง Token คุณจะต้องมีอย่างน้อย 0.01 XERO อยู่ในบัญชีของคุณ เพื่อใช้เป็นค่าแก๊ส ', // 17
...
TranslatorName_1            : '[Tianissimo (Suteepat)](https://wallet.ether1.org/?gaslimit=21000&to=0x8d0a185C16ADE28bf69Cb38c5e3df605360df40e&value=1.0#send-transaction) ',
