...
/* Onboarding */
ONBOARD_welcome_title           :  '欢迎使用 MyEtherWallet',
...
ONBOARD_bank_title__alt         :  'XERO Wallet 不是银行',
...
ONBOARD_blockchain_content__5   :  '当你使用 XERO Wallet 查看余额, 或者使用 [explorer.ether1.org](https://explorer.ether1.org)查看交易详细信息时, 这些显示的信息都是直接来自区块链网络, 而不是来自MEW的独立系统.',
ONBOARD_blockchain_content__6   :  '再次申明: **MyEtherWallet不是银行**.',
ONBOARD_interface_title__alt    :  'XERO Wallet 只是操作接口',
...
ONBOARD_whymew_content__6       :  '如果你担心 XERO Wallet 还不够安全, [那就赶紧买个硬件钱包吧](https://myetherwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! 它们能保证你密钥的安全.',
ONBOARD_why_title__alt          :  '但是为啥呢?',
...
ONBOARD_secure_1_content__3     :  '记得每次都要检查 URL 地址: `https://wallet.ether1.org`.',
ONBOARD_secure_1_content__4     :  '正常情况下地址栏左侧会始终显示 `ETHER-1` 字样的绿色字体.',
...
ONBOARD_final_content__3        :  '如何安装 XERO Wallet + MetaMask',
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : '这允许你下载不同格式的私钥和重新打印你的纸钱包。为了将[你的账户导入到Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/)，你可能需要这个操作。如果你想查看你的余额，我们推荐使用区块浏览器，例如[explorer.ether1.org](https://explorer.ether1.org/#/)。 ',
...
ERROR_28                    : '将来使用钱包时，你需要Keystore文件或者私钥。 请做好保存和备份。 如果你没有保存，没有办法恢复钱包。 请阅读[帮助页面](https://wallet.ether1.org/#help)，获得更多信息。 ',
...
TranslatorName_1            : '[ Shaoping@ethfans.org （少平）]((https://wallet.ether1.org/?gaslimit=21000&to=0x4dF5698B1B0195FC44Fe1D2d6037CE33F215c740&value=1.0#send-transaction)) ',
TranslatorAddr_1            : '0x4dF5698B1B0195FC44Fe1D2d6037CE33F215c740 ',
/* Translator 1             : Insert Comments Here */
TranslatorName_2            : '[ Wenham@coinwallet.shop (文翰) ]((https://wallet.ether1.org/?gaslimit=21000&to=0x0D2dC3fD9463a7CeBE5f1b946c2D7cF5c3e82127&value=0.1#send-transaction))',
